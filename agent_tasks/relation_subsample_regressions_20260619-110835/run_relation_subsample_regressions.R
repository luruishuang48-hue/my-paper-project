...
df <- df %>%
  mutate(
    ...
    primary_relation = case_when(
      ...
      investor == 1 ~ "investor",
      cloud == 1 ~ "cloud",
      real_upstream == 1 ~ "real_upstream",
      business_upstream == 1 ~ "business_upstream",
...
role_defs <- tribble(
  ...
  "owner", "发布方或所有者", "owner", "flag",
  "investor", "主要投资者", "investor", "flag",
  "cloud", "云服务方", "cloud", "flag",
  "business_upstream", "商业上游", "business_upstream", "flag",
  "real_upstream", "真实上游", "real_upstream", "flag",
  "broad_upstream", "上游合并", "broad_upstream", "flag",
  "business_downstream", "商业下游", "business_downstream", "flag",
  "real_downstream", "真实下游", "real_downstream", "flag",
...
exclusive_defs <- tribble(
  ...
  "investor", "互斥 主要投资者",
  "cloud", "互斥 云服务方",
  "real_upstream", "互斥 真实上游",
  "business_upstream", "互斥 商业上游",
  "competitor", "互斥 直接竞争者",
  "real_downstream", "互斥 真实下游",
  "business_downstream", "互斥 商业下游",

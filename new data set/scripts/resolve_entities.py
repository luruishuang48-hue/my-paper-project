#!/usr/bin/env python3
"""统一终审：读取 decisions/entity_decisions.csv，应用到 build_dataset.py 的匹配结果上。

替代旧的 resolve_manual_review.py + resolve_version_mismatches.py（两者已废弃删除）。
改进（对应 2026-07-02 审计报告第六节）：
